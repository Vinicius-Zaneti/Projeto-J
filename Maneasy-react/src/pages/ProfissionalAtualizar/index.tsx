...
function ProfissionalAtualizar() {
  ...
  return (
    ...
    <main id="profissional_atualizar" className="main_profissional_atualizar">
      <Menu />
        ...
        <div className="container_grid">
          ...
          <section className="conteudo">
            <nav className="nav_cad_cons">
              <Link to={"/pagina/profissional/cadastro"} className="btn_cad" >
                Cadastrar
              </Link>
...
export default ProfissionalAtualizar;